...
const USER_ID = 'Admin@abacaba.com'
// Channel name
const NETWORK_NAME = 'mainchannel'
// Chaincode
const CONTRACT_ID = "nodecc"
...
async function queryContract(contract){
    try{
        // Query the chaincode
        let response = await contract.evaluateTransaction("getAllAssets")
...
async function submitTxnContract(contract){
    try{
        // Submit the transaction
        let response = await contract.submitTransaction("createAsset","2","female","27")
